...
<div class="content-wrapper"  ng-app="myApp" ng-controller="optionController">
  ...
  <section class="content">
    <div class="row">
      <form role="form" ng-submit="saveOption()" method="post" id="addForm"  enctype="multipart/form-data">
            ...
            <div class="box-body">
				...
				<div class="table-responsive">
					...
					<tr ng-repeat="option in Options">
						...
						<td>
							<input type="number" class="form-control" ng-model="option.sortOrder">
						</td>
						<td>
