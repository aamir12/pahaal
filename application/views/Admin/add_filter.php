...
<div class="content-wrapper"  ng-app="myApp" ng-controller="filterController">
  <!-- Content Header (Page header) -->
  <section class="content-header">
    <h1>Add Filter</h1>
    <ol class="breadcrumb">
      <li><a href="<?=site_url().'Admin'; ?>"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active"><a href="<?=site_url().'Admin/filter'; ?>">Filter Management</a></li>
    </ol>
  </section>
  <!-- Main content -->
  <section class="content">
    <div class="row">
      <form role="form" ng-submit="saveFilter()" method="post" id="addForm"  enctype="multipart/form-data">
          ...
          <div class="box box-primary">
            <div class="box-body">
				...
				<div class="form-group">
					...
					<input type="number" ng-model="sortOrder" name="sortOrder" id="sortOrder"  class="form-control" placeholder="0" >
				</div>
				...
				<div class="table-responsive">
					...
					<tr ng-repeat="filter in filterOptions">
						<td>
							<input type="text" class="form-control" ng-model="filter.filterOption">
						</td>
						<td>
							<input type="number" class="form-control" ng-model="filter.sortOrder">
						</td>
						<td>
