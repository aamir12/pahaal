                  ...
                  <div class="col-sm-12">
                     <div class="main-menu addd_ii2">
                        ...
                        <div class="input-block search-outer">
                           <div class="input-box">
                              <form action="/search" method="get" class="big-deal-form search-bar" role="search" style="position: relative;">
                                 <div class="input-group search-bar">
                                    ...
                                    <input data-id="exampleInputPassword" class="search__input form-control" name="q" placeholder="Search Our Product" autocomplete="off" type="search">
